...
const MOCK = {
  companies: [
    // ── Partenaires locaux ─────────────────────────────────────────
    { id:1, name:'SIGTH-TECH CONGO', sector:'TIC', city:'Brazzaville', services:'Développement web et mobile, solutions informatiques sur mesure, hébergement cloud.', vision:'Être le partenaire N°1 du peuple congolais dans le domaine des TIC.', address:'84, Rue Mayama, Brazzaville', phone:'+242 06 634 00 00', email:'contact@sigth-tech.com', cover:'💻', initials:'ST' },
    { id:2, name:'BEST INFORMATIQUE', sector:'TIC', city:'Pointe-Noire', services:'Vente de matériel informatique, maintenance, formation, réseaux.', vision:'Digitaliser les entreprises congolaises à moindre coût.', address:'Centre-ville, Pointe-Noire', phone:'+242 05 512 00 00', cover:'🖥️', initials:'BI' },
    { id:3, name:'EGCM', sector:'Éducation & Formation', city:'Brazzaville', services:'Formation professionnelle qualifiante, coaching emploi, stages en entreprise.', vision:"Former la jeunesse congolaise pour l'emploi de demain.", address:'84, Rue Mayama, Immeuble BGF1, 1er étage', phone:'+242 06 681 00 00', email:'egcm@formation.cg', cover:'📚', initials:'EG' },
    { id:4, name:'AOFIP', sector:'Éducation & Formation', city:'Brazzaville', services:'Formation professionnelle et qualifiante, insertion professionnelle, coaching.', vision:"Vers l'emploi, mais pas seul.", address:'Rue Matsoua, Brazzaville', phone:'+242 06 672 00 00', cover:'🎓', initials:'AO' },
    { id:5, name:'AI COMMUNICATION', sector:'TIC', city:'Brazzaville', services:'Agence de communication digitale, création de contenu, réseaux sociaux, branding.', vision:'Booster la visibilité des marques congolaises.', address:'Plateau des 15 ans, Brazzaville', phone:'+242 06 663 00 00', email:'contact@aicommunication.cg', cover:'📡', initials:'AI' },
    { id:6, name:'MAGIC DESIGN', sector:'Culture & Arts', city:'Pointe-Noire', services:"Design graphique, identité visuelle, création de logo, impression.", vision:"L'art au service des entreprises.", address:'Avenue Lumumba, Pointe-Noire', phone:'+242 05 545 00 00', cover:'🎨', initials:'MD' },
    { id:7, name:'MUSAS CONGO', sector:'Commerce', city:'Brazzaville', services:'Distribution alimentaire, import-export, grossiste, livraison.', vision:'Nourrir le Congo, de Brazzaville à Owando.', address:'Marché Total, Brazzaville', phone:'+242 06 623 00 00', cover:'🛒', initials:'MC' },
    { id:8, name:'BTP PRO CONGO', sector:'BTP', city:'Dolisie', services:'Construction, rénovation, génie civil, architecture, études techniques.', vision:'Bâtir le Congo moderne, pierre par pierre.', address:'Centre-ville, Dolisie', phone:'+242 05 782 00 00', cover:'🏗️', initials:'BP' },
    // ── Grandes entreprises du Congo ───────────────────────────────
    { id:9, name:'BGFI Bank Congo', sector:'Finance & Banque', city:'Brazzaville', services:"Banque universelle, crédit aux entreprises et particuliers, épargne, transferts internationaux, monétique, crédit immobilier.", vision:"Être la banque de référence de l'Afrique Centrale.", address:'Boulevard Denis Sassou Nguesso, Centre-ville, Brazzaville', phone:'+242 05 305 00 00', email:'contact@bgfi.com', website:'www.bgfi.com', cover:'🏦', initials:'BG', verified:true },
    { id:10, name:'MTN Congo', sector:'Télécommunications', city:'Brazzaville', services:"Téléphonie mobile, internet 4G/5G, MTN Mobile Money, forfaits data, voix et SMS pour particuliers et entreprises.", vision:"Connecter chaque Congolais au monde numérique.", address:'Avenue du 31 Juillet, BP 2892, Brazzaville', phone:'8888', email:'customercare@mtn.cg', website:'www.mtn.cg', cover:'📡', initials:'MT', verified:true },
    { id:11, name:'Airtel Congo', sector:'Télécommunications', city:'Brazzaville', services:"Téléphonie mobile, Airtel Money, internet 4G, offres prépayées et postpayées, roaming international.", vision:"La connectivité accessible pour tous les Congolais.", address:'Avenue Matsoua, Quartier Poto-Poto, Brazzaville', phone:'128', email:'support@airtel.cg', website:'www.airtel.cg', cover:'📱', initials:'AC', verified:true },
    { id:12, name:'SNPC', sector:'Énergie & Pétrole', city:'Brazzaville', services:"Exploration, production et commercialisation du pétrole brut congolais. Partenariats JV avec TotalEnergies, ENI, Chevron.", vision:"Valoriser les ressources pétrolières du Congo au profit du peuple congolais.", address:'Avenue du Port, BP 188, Brazzaville', phone:'+242 05 622 00 00', email:'snpc@snpc.cg', cover:'⛽', initials:'SN', verified:true },
    { id:13, name:'TotalEnergies Congo', sector:'Énergie & Pétrole', city:'Pointe-Noire', services:"Distribution de carburants, lubrifiants, stations-service, gaz domestique, solutions industrielles.", vision:"Énergie propre et accessible à tous les Congolais.", address:'Port Autonome de Pointe-Noire, BP 1004', phone:'+242 05 534 00 00', email:'congo@totalenergies.com', website:'totalenergies.cg', cover:'🛢️', initials:'TE', verified:true },
    { id:14, name:'CIB (Congolaise Industrielle des Bois)', sector:'Sylviculture & Industrie', city:'Ouesso', services:"Exploitation forestière certifiée FSC, scierie industrielle, transformation du bois, exportation vers l'Europe et l'Asie.", vision:"Une industrie du bois responsable, durable et créatrice d'emplois au Congo.", address:'BP 3, Ouesso, Département Sangha', phone:'+242 05 767 00 00', email:'cib@cib-bois.com', cover:'🪵', initials:'CI', verified:true },
    { id:15, name:'Olam Congo', sector:'Agriculture & Commerce', city:'Brazzaville', services:"Négoce agricole, transformation alimentaire, huile de palme, sucre, farines. Distribution nationale et export.", vision:"Nourrir le monde en partant du Congo.", address:'Zone Industrielle, Brazzaville', phone:'+242 05 300 00 00', website:'www.olamgroup.com', cover:'🌿', initials:'OL', verified:true },
    { id:16, name:'Canal+ Congo', sector:'Médias & Divertissement', city:'Brazzaville', services:"Télévision par satellite, bouquets Canal+ Afrique, streaming, contenus africains et internationaux.", vision:"Le meilleur du divertissement pour l'Afrique.", address:'Avenue du Général de Gaulle, Brazzaville', phone:'+242 05 500 00 00', website:'www.canalplus.com/afrique', cover:'📺', initials:'C+', verified:true },
    { id:17, name:'Azur Assurances Congo', sector:'Assurances', city:'Brazzaville', services:"Assurance vie, multirisques habitation, auto, santé entreprise, responsabilité civile professionnelle.", vision:"Protéger les familles et les entreprises congolaises.", address:'Rue Lyautey, Centre-ville, Brazzaville', phone:'+242 05 558 00 00', email:'azur@azurassurances.cg', cover:'🛡️', initials:'AZ', verified:true },
    { id:18, name:'La Poste du Congo', sector:'Logistique & Services', city:'Brazzaville', services:"Courrier postal, envoi de colis, mandat postal, épargne postale, numérisation des services publics.", vision:"Relier chaque coin du Congo à moindre coût.", address:'Rond-Point de la Poste, Centre-ville, Brazzaville', phone:'+242 05 281 00 00', cover:'✉️', initials:'LP', verified:true },
    { id:19, name:'Hôtel Ledger Plaza Brazzaville', sector:'Tourisme & Hôtellerie', city:'Brazzaville', services:"Hôtel 5 étoiles, restaurant gastronomique, rooftop bar, salles de conférences, spa, piscine.", vision:"L'hospitalité haut de gamme au cœur de Brazzaville.", address:"Avenue de l'OUA, Centre-ville, Brazzaville", phone:'+242 06 514 00 00', website:'ledgerplazabrazzaville.com', cover:'🏨', initials:'HL', verified:true },
    { id:20, name:'CB Pharma Congo', sector:'Santé & Pharmacie', city:'Brazzaville', services:"Grossiste pharmaceutique, distribution de médicaments essentiels, dispositifs médicaux, vaccins.", vision:"Un médicament disponible pour chaque Congolais.", address:'Plateau des 15 ans, Brazzaville', phone:'+242 06 645 00 00', cover:'💊', initials:'CP', verified:false },
    // ── Grandes entreprises africaines ─────────────────────────────
    { id:21, name:'Dangote Group', sector:'Industrie & Commerce', city:'Lagos', services:"Ciment, sucre, farine, sel, pétrochimie. Leader industriel présent dans 20 pays africains.", vision:"Industrialiser l'Afrique depuis le continent.", address:'Union Marble House, 1 Alfred Rewane Road, Lagos, Nigeria', phone:'+234 1 280 4000', website:'www.dangote.com', cover:'🏭', initials:'DG', verified:true, country:'Nigeria 🇳🇬' },
    { id:22, name:'Safaricom', sector:'Télécommunications', city:'Nairobi', services:"Téléphonie mobile, M-Pesa Mobile Money (leader mondial du paiement mobile), internet 4G/5G, solutions IoT.", vision:"Transformer la vie des Africains par la technologie.", address:'Safaricom House, Waiyaki Way, Nairobi, Kenya', phone:'+254 722 000 000', website:'www.safaricom.co.ke', cover:'📶', initials:'SF', verified:true, country:'Kenya 🇰🇪' },
    { id:23, name:'Jumia Group', sector:'E-commerce & Tech', city:'Lagos', services:"Marketplace e-commerce panafricain, Jumia Food, Jumia Pay. Opère dans 11 pays africains.", vision:"Premier e-commerce africain coté en bourse (NYSE).", address:'94 Broad Street, Lagos, Nigeria', phone:'+234 700 JUMIA', website:'www.jumia.com', cover:'🛍️', initials:'JU', verified:true, country:'Nigeria 🇳🇬' },
    { id:24, name:'Equity Bank Group', sector:'Finance & Banque', city:'Nairobi', services:"Banque digitale, microfinance, crédit PME, assurance, EazzyBiz business banking. 7 pays africains.", vision:"Transformer des vies, donner de la dignité, étendre la prospérité.", address:'Equity Centre, Hospital Road, Nairobi, Kenya', phone:'+254 763 000 000', website:'www.equitybankgroup.com', cover:'🏦', initials:'EQ', verified:true, country:'Kenya 🇰🇪' },
  ],
  sectors: [
  ...
  universities: [
    { id:'u1', name:'Université Marien Ngouabi (UMN)', type:'Université Publique', city:'Brazzaville', country:'Congo 🇨🇬', faculties:['Droit, Économie & Gestion','Lettres & Sciences Humaines','Sciences & Techniques','Médecine & Pharmacie','ENSP Polytechnique','FLSH'], address:'Boulevard Denis Sassou Nguesso, BP 69, Brazzaville', phone:'+242 06 665 12 34', email:'rectorat@umng.cg', founded:1971, students:'25 000+', cover:'🎓', initials:'UMN', verified:true },
    { id:'u2', name:'ENSP (École Nationale Supérieure Polytechnique)', type:'École d\'Ingénieurs', city:'Brazzaville', country:'Congo 🇨🇬', faculties:['Génie Civil','Génie Électrique','Génie Informatique & Télécoms','Génie Chimique & Procédés','Génie Mécanique'], address:'Campus UMN, BP 69, Brazzaville', phone:'+242 06 612 00 00', email:'ensp@umng.cg', founded:1962, students:'2 500+', cover:'⚙️', initials:'EN', verified:true },
    { id:'u3', name:'IST Congo (Institut Supérieur de Technologie)', type:'Institut Privé', city:'Brazzaville', country:'Congo 🇨🇬', faculties:['Informatique & Réseaux','Développement Web & Mobile','Gestion Informatisée','Administration Systèmes & Cloud'], address:'Quartier Bacongo, Avenue Bouenza, Brazzaville', phone:'+242 06 680 00 00', email:'contact@ist-congo.com', founded:2003, students:'1 200+', cover:'💻', initials:'IS', verified:true },
    { id:'u4', name:'Université de Pointe-Noire (UPN)', type:'Université Publique', city:'Pointe-Noire', country:'Congo 🇨🇬', faculties:['Sciences & Techniques Pétrolières','Sciences Économiques','Droit des Affaires','Ingénierie Offshore'], address:'Avenue du Général de Gaulle, Pointe-Noire', phone:'+242 05 549 00 00', email:'upn@education.cg', founded:2012, students:'5 000+', cover:'🏛️', initials:'UP', verified:true },
    { id:'u5', name:'ESSEC Congo', type:'École de Gestion', city:'Brazzaville', country:'Congo 🇨🇬', faculties:['Commerce & Marketing','Finance d\'Entreprise','Management Interculturel','Entrepreneuriat & Innovation'], address:'Plateau des 15 ans, Brazzaville', phone:'+242 06 670 00 00', email:'info@essec-congo.com', founded:2008, students:'800+', cover:'📊', initials:'ES', verified:false },
    { id:'u6', name:'IFEG (Institut de Formation à l\'Expertise et à la Gestion)', type:'Institut Professionnel', city:'Brazzaville', country:'Congo 🇨🇬', faculties:['Comptabilité SYSCOHADA','Gestion des RH','Fiscalité Congolaise','Audit & Contrôle de Gestion'], address:'Rue Félix Éboué, Brazzaville', phone:'+242 06 655 00 00', email:'ifeg@formation.cg', founded:2005, students:'600+', cover:'📋', initials:'IF', verified:false },
    { id:'u7', name:'Université de Yaoundé I', type:'Université Publique', city:'Yaoundé', country:'Cameroun 🇨🇲', faculties:['Sciences','Médecine','Droit','Lettres','Économie & Gestion'], address:'Ngoa-Ekellé, BP 1365, Yaoundé', phone:'+237 222 23 13 89', email:'rectorat@uy1.uninet.cm', founded:1962, students:'45 000+', cover:'🎓', initials:'UY', verified:true },
    { id:'u8', name:'Université Cheikh Anta Diop (UCAD)', type:'Université Publique', city:'Dakar', country:'Sénégal 🇸🇳', faculties:['Sciences & Technologie','Droit','Médecine','Lettres','Sciences Économiques'], address:'Boulevard Dial Diop, Dakar', phone:'+221 33 825 05 30', email:'contact@ucad.sn', website:'www.ucad.sn', founded:1957, students:'80 000+', cover:'🏛️', initials:'UC', verified:true },
    { id:'u9', name:'Université Félix Houphouët-Boigny', type:'Université Publique', city:'Abidjan', country:'Côte d\'Ivoire 🇨🇮', faculties:['Sciences','Médecine','Droit','Lettres','Sciences Économiques'], address:'Cocody, 01 BP V 34, Abidjan', phone:'+225 27 22 44 08 21', email:'presidence@univ-fhb.edu.ci', founded:1963, students:'60 000+', cover:'🎓', initials:'UF', verified:true },
    { id:'u10', name:'Université de Kinshasa (UNIKIN)', type:'Université Publique', city:'Kinshasa', country:'RD Congo 🇨🇩', faculties:['Sciences','Médecine','Droit','Lettres','Sciences Sociales & Politiques'], address:'Campus de Lemba, BP 127, Kinshasa XI', phone:'+243 997 000 000', email:'rectorat@unikin.ac.cd', founded:1954, students:'35 000+', cover:'🏫', initials:'UK', verified:true },
    { id:'u11', name:'Université de Lomé', type:'Université Publique', city:'Lomé', country:'Togo 🇹🇬', faculties:['Sciences','Médecine','Droit','Lettres','ESTIM','FASEG'], address:'BP 1515, Lomé', phone:'+228 22 21 35 00', email:'presidence@univ-lome.tg', founded:1970, students:'25 000+', cover:'🎓', initials:'UL', verified:true },
    { id:'u12', name:'Université Omar Bongo (UOB)', type:'Université Publique', city:'Libreville', country:'Gabon 🇬🇦', faculties:['Sciences','Médecine','Droit','Lettres','Sciences Économiques'], address:'BP 13131, Libreville', phone:'+241 01 73 20 14', email:'rectorat@uob.ga', founded:1970, students:'20 000+', cover:'🏛️', initials:'UO', verified:true },
  ],
  entrepreneurs: [
...
function mockRoute(method, path, body) {
  ...
  if (resource === 'auth') {
    ...
    if (action === 'register') {
      ...
      if (body.company?.name) {
        ...
        const newCo = {id:Date.now()+1,...body.company,initials:body.company.name.slice(0,2).toUpperCase(),cover:'🏢',ownerId:user.id,createdAt:new Date().toISOString()};
  ...
  if (resource === 'companies') {
    ...
    if (method==='POST') {
      if (!currentUser) return {success:false,error:'Non authentifié'};
      const c = {id:Date.now(),...body,initials:(body.name||'').slice(0,2).toUpperCase(),cover:'🏢',ownerId:currentUser.id,createdAt:new Date().toISOString()};
    ...
    if (method==='PATCH'&&id) {
      ...
      if (body.name) companies[idx].initials=body.name.slice(0,2).toUpperCase();
      mockSave('companies',companies);
...
async function loadHome() {
  ...
  if (spotlight) spotlight.innerHTML=companiesAll.slice(0,4).map(c=>`
    <div class="spotlight-card" onclick="openCompany('${c.id}')">
      <div style="font-size:36px;margin-bottom:10px">${c.cover||c.initials}</div>
...
async function openCompany(id){
  ...
  div.innerHTML=`
    <div style="text-align:center;padding:24px;background:linear-gradient(135deg,rgba(74,142,255,.12),rgba(46,212,122,.08));border-radius:16px;margin-bottom:16px;border:1px solid rgba(255,255,255,.06)">
      <div style="font-size:56px;margin-bottom:8px">${c.cover||c.initials}</div>
...
async function loadMessages(){
  ...
  list.innerHTML=r.data.map(c=>`<div class="conv-item" onclick="openConv('${c.id}','${c.name}','${c.initials||c.name?.slice(0,2)||'?'}')">
    <div class="ci-avatar">${c.initials||c.name?.slice(0,2)||'?'}</div>
...
async function contactCompany(companyId){
  ...
  if(r.success){goTo('messages');setTimeout(()=>openConv(r.data.id,c?.name||'Entreprise',c?.initials||'?'),300);}
  else showToast(r.error||'Erreur','error');
}
